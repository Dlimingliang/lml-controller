...
import (
	...
	"github.com/Dlimingliang/lml-controller/pkg/generated/clientset/versioned/scheme"
...
func (c *ExampleV1Client) Lmls(namespace string) LmlInterface {
	return newLmls(c, namespace)
}
